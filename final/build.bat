...
gcc -Lbuild/ -Ilib/ -g main.c -o build/main.exe -I../external_lib/glfw/include -I../external_lib/glad/include ../external_lib/glfw/lib-mingw-w64/libglfw3dll.a -lgdi32