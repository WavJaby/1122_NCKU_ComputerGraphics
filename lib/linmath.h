...
LINMATH_H_FUNC void randomGradient(vec2 v, int ix, int iy) {
...
LINMATH_H_FUNC float dotGridGradient(int ix, int iy, float x, float y) {
...
LINMATH_H_FUNC float interpolate(float a0, float a1, float w) {
    return (a1 - a0) * (3.0 - w * 2.0) * w * w + a0;
}

// Sample Perlin noise at coordinates x, y
LINMATH_H_FUNC float perlin(float x, float y) {
